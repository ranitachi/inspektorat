...
@section('title')
    <title>Data Kelompok Penyebab</title>
@endsection
@section('modal')
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Tambah Data Kelompok Penyebab</h4>
				</div>
				<div class="modal-body">
					<form action="{{ route('data-penyebab.store') }}" method="POST">
						@csrf
	...
	<div class="modal fade" id="modalubah" tabindex="-1" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title">Ubah Data Kelompok Penyebab</h4>
				</div>
				<div class="modal-body">
	...
	<div class="modal fade" id="modalhapus" tabindex="-1" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title">Konfirmasi Hapus Data Kelompok Penyebab</h4>
				</div>
				<div class="modal-body">
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">Data Kelompok Penyebab</span>
...
@section('footscript')
	<script>
        ...
        $('#table').on('click', '.btn-edit', function(){
            ...
            $.ajax({
                url: "{{ url('data-penyebab') }}/"+id+"/edit",
                success: function(res) {
					$('#form-update').attr('action', "{{ url('data-penyebab') }}/"+id)
        ...
        $('#table').on('click', '.btn-delete', function(){
            var id = $(this).data('value')
			$('#form-delete').attr('action', "{{ url('data-penyebab') }}/"+id)			
        })
	</script>
@endsection